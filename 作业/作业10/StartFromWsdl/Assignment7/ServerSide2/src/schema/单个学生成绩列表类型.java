 ...
 *       &lt;sequence>
 *         &lt;element name="单项成绩" type="{http://jw.nju.edu.cn/schema}单项成绩类型" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class 单个学生成绩列表类型 {

    protected List<单项成绩类型> 单项成绩;
    @XmlAttribute
    protected String 学号;
     ...
     *
     */
    public List<单项成绩类型> get单项成绩() {
        if (单项成绩 == null) {
            单项成绩 = new ArrayList<单项成绩类型>();
        }
        return this.单项成绩;
    }

    public void set单项成绩(List<单项成绩类型> list){
        this.单项成绩 = list;
    }
