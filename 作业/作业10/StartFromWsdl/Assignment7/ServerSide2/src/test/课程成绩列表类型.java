 ...
 *         &lt;element name="courseScore" type="{http://jw.nju.edu.cn/schema}课程成绩类型"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class 课程成绩列表类型 {
    ...
    protected List<课程成绩类型> courseScore;
     ...
     * 
     */
    public List<课程成绩类型> getCourseScore() {
        if (courseScore == null) {
            courseScore = new ArrayList<课程成绩类型>();
        }
